...
<Diagram id="doc-block-htncku" title={"渐进式披露"} summary={"只有每个技能的名称+描述始终处于上下文中。当任务匹配时，全身会按需加载。"}>

```html
<div class="sk-flow">
  <div class="diagram-card">
    <span class="diagram-pill accent">始终在系统提示中</span>
    <div class="sk-list">
...
<AnnotatedCode
  ...
  annotations={[
    ...
    },
    {
      lines: "3-5",
      label: "触发器",
      note: "这个 `description` 是始终处于上下文中的**唯一**文本。准确地说明该技能“何时”应用。",
    },
    {
      lines: "9-14",
      label: "规则第一",
    ...
    },
    {
      lines: "27-30",
      label: "交联",
      note: "指出相关技能，以便代理可以将它们链接起来，而不是重新得出指导。",
    },
  ]}
/>
...
<Diagram id="doc-block-ua3x18" title={"哪个代理加载哪个技能"} summary={"范围决定应用程序内运行时代理是否看到技能。开发技能仅对您的编码代理可见。"}>
...
<div class="sc-grid">
  ...
  <div class="sc-targets">
    ...
    <div class="diagram-box">
      编码 Agent<br /><small class="diagram-muted"
