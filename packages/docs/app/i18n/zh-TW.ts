const messages = {
  ...
  templates: {
    ...
    video: {
      replaces: "替換或增強影片編輯",
      description:
        "使用 Remotion 建置基於 React 的影片作品。關鍵幀動畫、30+ 緩動曲線、攝影機控制和代理輔助編輯。",
    },
    analytics: {
  ...
  templateLanding: {
    ...
    clips: {
      ...
      s058: "免費和開放原始碼",
      s059: "幾分鐘內即可開始使用",
      s060: "分叉範本，插入儲存，然後開始錄製您的團隊實際擁有的剪輯。",
      s061: "閱讀檔案",
      s062: "檢視所有範本",
    },
    content: {
    ...
    video: {
      ...
      s024: "動畫相機關鍵幀",
      s025: "互動式游標系統",
      s026: "三種游標樣式，具有懸停區域偵測、平滑過渡和點選動畫。非常適合產品示範。",
      s027: "箭頭",
      s028: "指針",
      s029: "工字鋼",
      s030: "多關鍵幀編輯",
