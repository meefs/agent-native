const messages = {
  ...
  animations: {
    ...
    close: "關閉動畫面板",
    emptyTitle: "還沒有動畫。",
    emptyDescription: "在下方新增元素，讓它們點選後顯示。",
    clearAll: "全部清除",
    elements: "元素",
    autoFill: "自動填充",
  ...
  deckEditor: {
    ...
    verifySharedAccessFailed:
      "無法驗證此簡報是否與你的帳戶共用。請重試以重新載入團隊存取權限和幻燈片。",
    joinTeamDescription:
  ...
  designSystemSetup: {
    ...
    newDescription: "提供任意來源組合；脈絡越多，結果越好。",
    companyBrand: "公司 / 品牌",
    companyBrandPlaceholder: "Acme Inc. — 我們建置開發者工具...",
    figmaFile: "Figma 檔案",
    parsingFigmaFile: "正在啟動 Builder 索引...",
    uploadFigDescription: "上傳本機 .fig 副本以使用 Builder 建立索引",
    ...
    codeFiles: "程式碼檔案",
    codeFilesDrop: "CSS、Tailwind 設定、主題檔案 — 拖放或點選",
    documents: "檔案和簡報",
