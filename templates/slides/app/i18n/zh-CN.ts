const messages = {
  ...
  designSystemSetup: {
    ...
    newDescription: "提供任意来源组合；上下文越多，结果越好。",
    companyBrand: "公司 / 品牌",
    companyBrandPlaceholder: "Acme Inc. — 我们构建开发者工具...",
    figmaFile: "Figma 文件",
    parsingFigmaFile: "正在启动 Builder 索引...",
    uploadFigDescription: "上传本地 .fig 副本以使用 Builder 建立索引",
    ...
    codeFiles: "代码文件",
    codeFilesDrop: "CSS、Tailwind 配置、主题文件 — 拖放或点击",
    documents: "文档和演示文稿",
