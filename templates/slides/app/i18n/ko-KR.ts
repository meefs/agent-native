const messages = {
  ...
  designSystemSetup: {
    ...
    newDescription:
      "소스를 자유롭게 조합해 제공하세요. 맥락이 많을수록 결과가 좋아집니다.",
    companyBrand: "회사 / 브랜드",
    companyBrandPlaceholder: "Acme Inc. — 개발자 도구를 만듭니다...",
    figmaFile: "Figma 파일",
    parsingFigmaFile: "Builder 색인 생성을 시작하는 중...",
    uploadFigDescription: "Builder로 색인 생성할 로컬 .fig 사본을 업로드하세요",
    ...
    codeFiles: "코드 파일",
    codeFilesDrop: "CSS, Tailwind 설정, 테마 파일 — 드롭하거나 클릭",
