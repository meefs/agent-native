const messages = {
  ...
  designSystemSetup: {
    ...
    newDescription:
      "स्रोतों का कोई भी संयोजन दें; जितना अधिक संदर्भ होगा, परिणाम उतना बेहतर होगा।",
    companyBrand: "कंपनी / ब्रांड",
    companyBrandPlaceholder: "Acme Inc. — हम डेवलपर टूल बनाते हैं...",
    figmaFile: "Figma फ़ाइल",
    parsingFigmaFile: "Builder indexing शुरू की जा रही है...",
    uploadFigDescription: "Builder से index करने के लिए स्थानीय .fig कॉपी अपलोड करें",
