const messages = {
  ...
  designSystemSetup: {
    ...
    parsingFigmaFile: "Starting Builder indexing...",
    uploadFigDescription: "Upload a .fig local copy to index it with Builder",
    ...
    codeFilesDrop: "CSS, Tailwind config, theme files — drop or click",
